...
var Button = function Button(props) {
  ...
  var customClassName = props.className,
      ...
      block = props.block,
      size = props.size,
      rest = _objectWithoutProperties(props, ['className', 'component', 'variant', 'small', 'large', 'href', 'type', 'block', 'size']);
  ...
  if (!!href) return _react2.default.createElement('a', _extends({
    href: href,
    className: className
  }, rest));

  if (component === 'button') return _react2.default.createElement('button', _extends({
    type: type,
    className: className
  }, rest));
