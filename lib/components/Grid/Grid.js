  ...
  _createClass(Grid, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          match = _props.match,
          rest = _objectWithoutProperties(_props, ['className', 'component', 'gutter', 'divider', 'match']);

      var className = (0, _classnames2.default)(customClassName, 'uk-child-width-expand', (_classNames = {}, _defineProperty(_classNames, 'uk-grid-' + gutter, gutter), _defineProperty(_classNames, 'uk-grid-divider', divider), _defineProperty(_classNames, 'uk-grid-match', match), _classNames));
